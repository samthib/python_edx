# -*- coding: utf-8 -*-
"""
Created on Fri May  1 16:07:22 2020
...
region_cols = []
for clr in whisky.Region:
    region_cols.append(region_colors.get(clr))
...
classification_cols = []
for grp in whisky.Group:
    classification_cols.append(cluster_colors[grp])
